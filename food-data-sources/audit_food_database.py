...
REQUIRED_NAMES = {
    ...
    "Том ям с креветками", "Пад тай с курицей", "Тайский зелёный карри с курицей",
    "Плов с бараниной по-узбекски", "Лагман с говядиной", "Самса с мясом, печёная",
    "Чкмерули", "Хачапури по-гурийски", "Чихиртма",
    "Мисо-суп с тофу", "Суши с лососем", "Курица терияки",
    "Дал тадка", "Бирьяни с курицей", "Курица тандури",
    "Ош с бараниной", "Куртоб", "Мастоба",
    "Спагетти болоньезе", "Крем-суп из тыквы по-итальянски", "Пицца Маргарита",
    "Пицца Пепперони", "Лазанья болоньезе", "Тирамису",
}
SEMANTIC_RULES = (
...
def main(database=DATABASE) -> None:
    ...
    required_regional_groups = ("Русская кухня", "Кавказская кухня", "Тайская кухня", "Узбекская кухня",
                                "Грузинская кухня", "Японская кухня", "Индийская кухня", "Таджикская кухня",
                                "Итальянская кухня")
    if (group_counts["Русская кухня"] < 40 or group_counts["Кавказская кухня"] < 40
            or any(group_counts[group] < 15 for group in required_regional_groups[2:])):
